...
gaoptions=gaoptimset('CreationFcn',@createFcn,'CrossoverFcn',@crossoversinglepoint,...
    ...
    'PopulationSize',2,'PopulationType','doubleVector',...
    'SelectionFcn',@selectionroulette,'StallGenLimit',5,...
    'TolFun', 1e-10, 'EliteCount', 1, 'Vectorized','off');
...
[x,fval,exitFlag]=ga(@(x)objFnc(x, ConeHeight),nVariables,A,b,[],[],lowerBound,[],[], gaoptions);
