function [xOut, varargout] = truncate(x, minX, maxX, varargin)
% TRUNCATE
%
% truncates x to the range minX and maxX
%
% See also
%
% Examples
% x = truncate(x, minX, maxX);
% [x, y] = truncate(x, minX, maxX, y);
% [x, y1, y2] = truncate(x, minX, maxX, y, y1, y2);
%
% Copyright 2012
% Paul Leu
...
if isempty(ind)
  error('Truncation cannot be performed; check minX and maxX');
end
xOut = x(ind);
