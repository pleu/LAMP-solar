...
cie = SolarSpectrum.read_CIE();

idCIENormal = IntegratedData(cie, srNormal);
idCIENormal.ReflectionIntegrated

idCIETE = IntegratedData(cie, srTE);
idCIETE.ReflectionIntegrated

idCIETM = IntegratedData(cie, srTM);
idCIETM.ReflectionIntegrated
