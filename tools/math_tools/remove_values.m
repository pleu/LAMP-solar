function [xOut, varargout] = remove_values(x, minX, maxX, varargin)
% TRUNCATE
%
% removes values of x between range minX and maxX
%
% See also
%
% Examples
% x = remove_values(x, minX, maxX);
% [x, y] = remove_values(x, minX, maxX, y);
% [x, y1, y2] = remove_values(x, minX, maxX, y, y1, y2);
%
% Copyright 2012
% Paul Leu
