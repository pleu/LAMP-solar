...
SimulationModel = Model(FilmConeHoleTop.create_withEquivalentThickness(effectiveThickness, zSpan, xSpan, rtop, rbot), PlaneSource, FrequencyDomainFieldPower, FrequencyDomainFieldPower, FDTD);
