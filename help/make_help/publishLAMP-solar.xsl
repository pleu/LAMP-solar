...
<xsl:variable name="LAMPsolarversion" select="document('LAMPsolar_version.xml')//LAMPsolar/version"/>
...
<xsl:template name="header">
  <xsl:param name="sourceref"/>
    ...
    <table class="nav" summary="Navigation aid" border="0" width="100%" cellpadding="0" cellspacing="0">
      <tr><td valign="baseline"><b>LAMP-solar</b> - A MATLAB Toolbox for Solar Cell Analysis</td>
...
<xsl:template name="footer">
  ...
  <table class="footer" border="0" width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td valign="baseline" align="right"><xsl:value-of select="$LAMPsolarversion"/></td><td valign="baseline" align="right"></td>
    </tr>
  </table>  
</xsl:template>
