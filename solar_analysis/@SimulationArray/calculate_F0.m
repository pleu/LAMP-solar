function F0 = calculate_F0(sa, ma)
...
be = SolarSpectrum.calculate_be(energyVector, 0, Constants.LightConstants.T_c, Constants.LightConstants.F_a)';
...
F0 = trapz(phiVector, trapz(thetaVector, trapz(energyVector(energyVector >= ma.BandGap), integrand(:, energyVector >= ma.BandGap, :),2), 1), 3);
