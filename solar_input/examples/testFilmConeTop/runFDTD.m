...
SimulationModel = Model(FilmConeTop.create_withEquivalentThickness(effectiveThickness, zSpan, xSpan, rtop, rbot), PlaneSource, FrequencyDomainFieldPower, FrequencyDomainFieldPower, FDTD);
