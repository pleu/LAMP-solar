...
function runFDTD(a, ConeHeight, rtop, rbot)
...
SimulationModel = Model(Nanocone.create_withConeHeight(ConeHeight, rtop, rbot), PlaneSource, FrequencyDomainFieldPower, FrequencyDomainFieldPower, FDTD);
...
fprintf(fid, ['filename = ','"rtop' num2str(rtop*1e9), 'rbot' num2str(rbot*1e9), 'a" +num2str(', num2str(a*1e9), ')' '; \n']);  
fclose(fid);
savescript('runFDTD');
