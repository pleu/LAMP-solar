function runFDTD(equivalentThickness, zSpan, xSpan, TopConezSpan, Toprtop,Toprbot, ntop, Botrtop, Botrbot, nbot)
...
fprintf(fid, 'delete; \n');
fprintf(fid, ['a=', num2str(P) ';\n']);
fprintf(fid, ['ntop=',num2str(ntop) ';\n']);
fprintf(fid, ['nbot=',num2str(nbot) ';\n']);

SimulationModel = Model(FilmConeHoleArrayBoth.create_withEquivalentThickness(equivalentThickness, zSpan, xSpan, TopConezSpan, Toprtop, Toprbot, ntop, Botrtop, Botrbot, nbot), PlaneSource, FrequencyDomainFieldPower, FrequencyDomainFieldPower, FDTD);

filmConeHoleArray = SimulationModel.Structures;
filmConeHoleArray.FilmMaterial = 'Si (Silicon)';
filmConeHoleArray.TopConeMaterial = 'etch';
filmConeHoleArray.BotConeMaterial = 'etch';
...
Source.FrequencyWavelength.WavelengthMax = 4e-6;
